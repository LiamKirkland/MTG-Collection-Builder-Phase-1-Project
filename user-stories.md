...
### Feature 3 - Add Card to Collection
User story: As a user, I want to add cards to my collection. Additionally, I would like to add custom attributes like a Comment, it's print (Standard v Foil), Art style (Standard v Full Art), and Condition (Near Mint, Lightly, Moderaretly Played, Heavily Player, Damaged).  
*Details: Add a form that accepts the custom attributes. On submit, add the card and it's attributes to the collection*

### Feature 4 - Display User's Card Collection
User story: As a user, I want to view my current card collection. I wnat the collection to update everytime I add a new card from search. Clicking on a card from my collection displays it's standard card info, as well as its user-specified info.  
*Details: Add a space at the bottom of the page to display the collection. Allow user to click individual cards or use the arrow keys to go thru them.*

### Feature 5 - Update or Delete Cards in Collection
